 ...
 Are you always returning a new location within a navigation guard? That would lead to this error. Only return when redirecting or aborting, that should fix this. This might break in production if not fixed.`);
  ...
  const router2 = {
    ...
    install(app) {
      ...
      if (isBrowser) addDevtools(app, router2, matcher);
    }
  };
...
const logoSvg = "/themes/wenui/dist/logo.svg";
...
const _sfc_main$2 = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { route, isDictationActive, get useRoute() {
      return useRoute;
...
const _hoisted_1$2 = { class: "main-menu" };
const _hoisted_2$1 = { class: "container mx-auto md:px-4" };
const _hoisted_3 = { class: "grid grid-cols-12" };
const _hoisted_4 = { class: "py-3 col-span-6 md:col-span-3 pl-4 md:pl-0" };
const _hoisted_5 = ["src"];
const _hoisted_6 = { class: "menu col-span-12 md:col-span-8" };
  ...
  return openBlock(), createElementBlock("nav", _hoisted_1$2, [
    createBaseVNode("div", _hoisted_2$1, [
      createBaseVNode("div", _hoisted_3, [
        ...
        createCommentVNode(' <div class="tools md:order-last col-span-6 md:col-span-1 flex items-center justify-end pr-4 md:pr-0 gap-2">\n          <router-link\n            to="/settings"\n            class="menu-item"\n            active-class="menu-item menu-item-active">\n            设置\n          </router-link>\n          <router-link\n            to="/question-bank-editor"\n            class="menu-item"\n            active-class="menu-item menu-item-active">\n            加题\n          </router-link>\n        </div> '),
        createBaseVNode("div", _hoisted_6, [
          createVNode(_component_router_link, {
            to: "/words",
            class: normalizeClass(["inline-flex items-center px-1 pt-1 border-b-2 text-base font-medium transition-colors duration-200", [_ctx.$route.path.startsWith("/words") ? "border-indigo-500 text-gray-900" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"]]),
          ...
          createVNode(_component_router_link, {
            to: "/dictation",
            class: normalizeClass(["menu-item", { "menu-item-active": $setup.isDictationActive }])
          }, {
...
const NavBar = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["__file", "/home/wenroo/dev/juniorgrade3/web/themes/wenui/app/components/NavBar.vue"]]);
const _sfc_main$1 = {};
const _hoisted_1$1 = { class: "bg-white border-t border-slate-100 mt-auto py-6 text-center text-slate-400 text-sm" };
function _sfc_render$1(_ctx, _cache) {
  return openBlock(), createElementBlock("footer", _hoisted_1$1, [..._cache[0] || (_cache[0] = [
    createBaseVNode(
      "p",
      null,
      "© 2025 Bill.Wei Word Flow Learning System",
      -1
      /* CACHED */
    )
  ])]);
}
const AppFooter = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__file", "/home/wenroo/dev/juniorgrade3/web/themes/wenui/app/components/AppFooter.vue"]]);
const _sfc_main = {
  __name: "App",
  setup(__props, { expose: __expose }) {
    __expose();
    const __returned__ = { NavBar, AppFooter };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    createVNode($setup["AppFooter"])
  ]);
}
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/home/wenroo/dev/juniorgrade3/web/themes/wenui/app/App.vue"]]);
const scriptRel = "modulepreload";
const assetsURL = function(dep) {
  return "/themes/wenui/dist/" + dep;
};
const seen = {};
...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: "/words",
      name: "words",
      component: () => __vitePreload(() => import("../assets/WordsPage-D0nHhRpK.js"), true ? [] : void 0)
    }
    // {
    //   path: '/irregular',
    //   name: 'irregular',
